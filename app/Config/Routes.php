...
// pelanggan routes
$routes->resource('api/pelanggan', ['controller' => 'PelangganController']);
...
// penjualan routes
$routes->resource('api/penjualan', ['controller' => 'PenjualanController']);
...
// produk routes
$routes->resource('api/produk', ['controller' => 'ProdukController']);
...
$routes->resource('api/detail-penjualan', ['controller' => 'DetailPenjualanController']);
